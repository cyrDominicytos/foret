...
use App\Http\Requests\Admin\IntervenantStoreCrudRequest as StoreRequest;
use App\Http\Requests\Admin\IntervenantUpdateCrudRequest as UpdateRequest;
...
class IntervenantCrudController extends \App\Http\Controllers\Admin\SuperAdminController {
...
//        $this->crud->setEntityNameStrings(trans('backpack::permissionmanager.user'), trans('backpack::permissionmanager.users'));
        $this->crud->setEntityNameStrings(trans('backpack::permissionmanager.user'), 'Autres Intervenants'); //détermine le nom affiché dans le titre du crud
        $this->crud->setRoute(backpack_url('intervenant'));
...
//        $this->crud->setDetailsRowView('admin.user.details_row');
    ...
    public function setupListOperation() {
        $this->crud->setColumns([
            ...
            [
                'name' => 'poste_intervenant',
                'label' => 'Poste Intervanant',
                'type' => 'text',
            ],
...
//            ],
        ...
        $this->crud->addClause('whereHas', 'intervenant');
    }
...
//------------------From backpack------------------------------------------
        ...
        $intervenant->id_poste = $request->nouveau_poste;
        $intervenant->titre = $request->titre_intervenant;
        $intervenant->created_at = Carbon::now();
        $item->intervenant()->save($intervenant);
...
//        $this->crud->setRequest($this->handlePasswordInput($this->crud->getRequest()));
        ...
        $intervenant->titre = $request->titre_intervenant;
        $intervenant->updated_at = Carbon::now();
        $intervenant->save();
...
//        }
    ...
    protected function addCreateUserFields() {
        $this->crud->addFields([
            ...
            [// select_from_array
                'name' => 'nouveau_poste',
                'label' => "Poste Intervenant",
                'type' => 'select_from_array',
                'options' => Poste::whereIn('id', [163, 164, 165])->pluck('nom', 'id'),
                'allows_null' => True,
                'default' => '',
            ...
            [// SelectMultiple = n-n relationship (with pivot table)
                ...
                'options' => (function ($query) {
                    return $query->orderBy('display_name', 'ASC')->whereIn('name', ['Agent_PAC', 'Agent_CNCB', 'Agent_Douane'])->get();
                    ;
