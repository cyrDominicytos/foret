...
class Liquidation extends AppModele
{
    use CrudTrait;
    ...
    //
     ...
     protected $fillable = [ 'autorite','observation', 'date_liquidation','id_procedure_exportation'];




     public function get_liquidation_all_info_by_id($id) {
         return DB::table('liquidations')
         ->join('procedure_exportations', 'liquidations.id_procedure_exportation', '=', 'procedure_exportations.id')
         ...
         ->join('intervenants', 'intervenants.id', '=', 'liquidations.autorite')
         ...
         ->select(
         'liquidations.id',
         'liquidations.autorite',
         'liquidations.id_procedure_exportation',
         'liquidations.observation',
         'liquidations.date_liquidation',
    ...
    public function get_liquidation_all_info_by_process($process,$usager) {
         return DB::table('liquidations')
         ->join('procedure_exportations', 'liquidations.id_procedure_exportation', '=', 'procedure_exportations.id')
         ->join('demande_annuelles', 'demande_annuelles.id', '=', 'procedure_exportations.id_demande_annuelle') 
         ->join('usagers', 'procedure_exportations.id_usager', '=', 'usagers.id')
     ...
     )    ->where('liquidations.id_procedure_exportation', $process)
         ->where('usagers.id', $usager)
          ->orderBy('procedure_exportations.created_at', 'DESC')
          ->get();
    }
}
