...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" style="margin-bottom: 3%;">
		<div class="col-md-12">
			<h3 style="text-align: center;">FERMETURE D’UNE PROCÉDURE D’EXPORTATION</h3>
			<div class="card">
				...
				<?php
					...
					echo Form::open(array('route' => 'liquidation.fermer', 'method' => 'post', 'id'=> 'idProcedureForm3', 'enctype'=> 'multipart/form-data'))
	...
	<div class="col-md-12">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;">FERMETURE DE PROCEDURE</h3>
				</div>
				...
				<div class="col-md-4 offset-md-4">
								<div class="form-group">
											...
											echo Form::label('ref_file', 'Joindre Document');
											echo Form::label('ref_file', '*',array('style' => 'color:red'));
											?>
											<input type="file" name="doc" id="doc"  title='Seuls les documents pdf, image ou word sont autorisés'>
								</div>
							</div>
			</div>
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::label('date_let_pass', 'Date Fermeture');
						...
						<div class="col-md-4 offset-md-2">
							<div class="form-group">
										...
										<?php
											...
											echo Form::label('info_agent', 'Fermé par' );
 ...
 <div class="col-md-2 offset-md-4">
		...
		<?php
		echo Form::submit('Fermer', array('class' => 'btn btn-block btn-success','id'=>'save'));
		?>			
		</div>
