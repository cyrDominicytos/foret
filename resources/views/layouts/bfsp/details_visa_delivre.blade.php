...
<div class="row">
		...
		<div class="card-body">
			...
			if (!empty(trim($visa->observation))) {
			?>
				<div class="row" style="margin-top: 2%;">
						<div class="col-md-12">
							<div class="form-group" id="id_observation">
								...
								echo Form::textarea('observation',$visa->observation,array('class' => 'form-control','style'=>'resize:none;','maxlength'=>'1000','rows'=>'4','disabled'=>'true'));
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::label('date_let_pass', 'Date du visa');

									echo Form::text('date_let_pass',$visa->date_visa,array('class' => 'form-control','readonly' => 'readonly'));
						...
						<div class="col-md-4 offset-md-2">
							<div class="form-group">
									...
									echo Form::label('info_agent', 'Grade, Nom et prénom de l’agent' );
											echo Form::text('info_agent',forestier_user_id($visa->autorite)->grade.', '.user_by_id($visa->autorite)->firstname.' '.user_by_id($visa->autorite)->name,array('class' => 'form-control','readonly' => 'readonly'));
