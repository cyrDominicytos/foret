<h3 style="text-align: center;padding-top: 2%;">LISTE DES DEMANDES EN ATTENTE D'AVIS TECHNIQUE REJETES</h3>
      <div class="card">
                  ...
                  <tbody>
                      ...
                      @foreach($detailsDemandeRejets as $detailsDemandeRejet)
                        <tr>
                            ...
                            <td>
                               <a type="button" class="btn btn-block btn-primary" href="{{ route('show.demande_AT_rejet', $detailsDemandeRejet->id) }}">Traiter</a>
                            </td>
                        </tr>
                      @endforeach
