...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" >
		<div class="col-md-12">
			<h3 style="text-align: center;">CONTRE CONSTAT DE CONFORMITÉ D’UNE PROCÉDURE D’EXPORTATION</h3>
			<div class="card">
				...
				<?php
					...
					echo Form::open(array('url' => '/contre_constat/store', 'method' => 'POST','id'=>'form'))
...
<div class="row" style="margin-top: 2%">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											echo Form::text('start_pass_validity',formater_date($detailsLaissezPassers->debut_validite),array('class' => 'form-control', 'readonly' => 'readonly'));
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											echo Form::text('end_pass_validity',formater_date($detailsLaissezPassers->fin_validite),array('class' => 'form-control', 'readonly' => 'readonly'));
	...
	<div class="row" style="margin-top: 2%">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;">DÉCISION  CONTRE CONSTAT </h3>
				</div>
		...
		<div class="card-body">
			<div class="col-md-12">
				<div class="row offset-md-1 col-md-10">
					<table>
						<tr>
							<td><span style="font-size: 18px;font-weight: bold">Conformité aux informations du constat de conformité ci-dessus</span></td>
							<td>
								<?php

							

							echo Form::label('conforme', 'SONT CONFORMES',array('style'=>'font-size:14px;margin-left:15px;font-size:14px;'));
							echo "<br>"; 
							echo Form::radio('conforme','1','',array('style'=>'width:80px;height:40px;margin-left:25px;','id'=>'conforme','onclick'=>'verify()','required'=>true));
							...
							echo Form::label('conforme', 'SONT NON CONFORMES',array('style'=>'font-size:14px;margin-left:15px;font-size:14px;'));
							echo "<br>"; 
							echo Form::radio('conforme','0','',array('style'=>'width:80px;height:40px;margin-left:25px;','id'=>'no_conforme','onclick'=>'verify()'));
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::label('date_let_pass', 'Date du Contre constat ');

									echo Form::text('date_let_pass',date('d-m-Y à H:i:s'),array('class' => 'form-control','readonly' => 'readonly'));
