...
<div class="container-fluid" style="margin-top: 2%;">
	...
	<div class="row">
		...
		<div class="card-body">
			...
			if (!empty($procedureEnAttentesDetails->raison_rejet)) {
			?>
				<div class="row" style="margin-top: 2%;">
						<div class="col-md-12">
							<div class="form-group" id="id_observation">
								...
								echo Form::textarea('observation',$procedureEnAttentesDetails->raison_rejet,array('class' => 'form-control','style'=>'resize:none;','maxlength'=>'1000','rows'=>'4','disabled'=>'true'));
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::text('date_let_pass',formater_datetime($procedureEnAttentesDetails->date_rejet),array('class' => 'form-control','readonly' => 'readonly'));
