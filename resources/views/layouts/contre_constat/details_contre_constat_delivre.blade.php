...
<div class="container-fluid" style="margin-top: 2%;">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;">DÉTAIL DU CONTRE CONSTAT</h3>
				</div>
				...
				<div class="row offset-md-1 col-md-10">
					<table>
						<tr>
							...
							echo Form::label('conforme1', ' SONT CONFORMES',array('style'=>'font-size:14px;margin-left:15px;font-size:14px;'));
							echo "<br>"; 
							echo Form::checkbox('conforme1','1',($procedureEnAttentesDetails->conformite_au_constat_conformite==1) ? (1) : (0),array('style'=>'width:80px;height:40px;margin-left:25px;background-color:blue','disabled'=>'true'));
								?>	
							</td>
							<td>
								<?php
							echo Form::label('no_conforme1', 'SONT NON CONFORMES',array('style'=>'font-size:14px;margin-left:15px;font-size:14px;'));
							echo "<br>"; 
							echo Form::checkbox('no_conforme1','0',($procedureEnAttentesDetails->conformite_au_constat_conformite==0) ? (1) : (0),array('style'=>'width:80px;height:40px;margin-left:25px;','disabled'=>'true'));
								?>	
							</td>
						</tr>
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::text('date_let_pass',formater_datetime($procedureEnAttentesDetails->date_contre_constat),array('class' => 'form-control','readonly' => 'readonly'));
