        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <h3>{{ benin_control_info()['bc_attente']}} </h3>

                <p>Procédure en attente de scanning</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{ benin_control_info()['bc_conforme']}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{ benin_control_info()['bc_non_conforme']}}</h3>
          ...
          <div class="row mb-2">
            <div class="col-sm-4"></div>
              ...
              <div class="card-header">
                <h3 class="card-title">Les 10 dernières procédures d'exportations en attente de scanning</h3>
              </div>
            <div class="col-sm-4"></div>
            </div>
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   {{formater_datetime($procedure->created_at)}}</td>
                    ...
                    <td>
                       <a type="button" href="{{ Route('scan_form',$procedure->id) }}" class="btn btn-block btn-primary">Traiter</a>
