                    ...
                    <td>
                       ...
                       { 
                        ?>
                         ...
                         <a type="button" href="{{ Route('regle_bfu',$procedure->id) }}" class="btn btn-block btn-primary">Traiter</a>
                      <?php
                         
                       } else{
                        ?>
                           <a type="button" href="{{ Route('joindre_bfu',$procedure->id) }}" class="btn btn-block btn-primary">Traiter</a>
                        <?php
                       }
                      ?>   
