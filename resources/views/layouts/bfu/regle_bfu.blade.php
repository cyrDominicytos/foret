...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" style="margin-bottom: 3%;">
		<div class="col-md-12">
			<h3 style="text-align: center;">REGLEMENT DU BFU D’UNE PROCÉDURE D’EXPORTATION</h3>
			<div class="card">
				...
				<?php
					...
					echo Form::open(array('route' => 'bfu.save_bfu_regle', 'method' => 'post', 'id'=> 'idProcedureForm3', 'enctype'=> 'multipart/form-data'))

				?>
				@csrf
				<input type="number" name="id" hidden="" value="{{$procedureEnAttentesDetails->id}}">
				<input type="number" name="id2" hidden="" value="{{$procedureEnAttentesDetails->id_procedure_exportation}}">
				<div class="card-body">
					<div class="col-md-12">
						<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;">JOINDRE LE BFU REGLE</h3>
				</div>
		...
		<div class="card-body">
			<div class="row">
							...
							<div class="form-group">
								...
								echo Form::label('vgm', 'Joindre le BFU réglé');
								echo Form::label('vgm', '*',array('style' => 'color:red'));
								echo Form::input('file','bfu',null, array('class' => 'form-control','id'=>'vgm','onchange'=>'checkfile();', 'title'=>'Seuls les documents pdf, image ou word sont autorisés'));
				...
				<div class="row" style="margin-top: 2%;">
						<div class="col-md-12">
							<div class="form-group" id="id_observation">
								...
								echo Form::textarea('observation',$procedureEnAttentesDetails->observation,array('class' => 'form-control','style'=>'resize:none;','maxlength'=>'1000','rows'=>'4','readonly' => 'readonly'));
						...
						<div class="offset-md-1 col-md-4">
							<div class="form-group">
								...
								<?php
									...
									echo Form::label('date_let_pass', 'Date du BFU');
						...
						<div class="col-md-4 offset-md-2">
							<div class="form-group">
										...
										<?php
											...
											echo Form::label('info_agent', 'Délivré par' );
