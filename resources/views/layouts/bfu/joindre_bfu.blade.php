...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" style="margin-bottom: 3%;">
		<div class="col-md-12">
			<h3 style="text-align: center;">BFU D’UNE PROCÉDURE D’EXPORTATION</h3>
			<div class="card">
				...
				<?php
					...
					echo Form::open(array('route' => 'bfu.save_bfu', 'method' => 'post', 'id'=> 'idProcedureForm3', 'enctype'=> 'multipart/form-data'))
	...
	<div class="col-md-12">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;">JOINDRE LE BFU</h3>
				</div>
		...
		<div class="card-body">
			<div class="row">
							...
							<div class="form-group">
								...
								echo Form::label('vgm', 'Joindre le BFU');
