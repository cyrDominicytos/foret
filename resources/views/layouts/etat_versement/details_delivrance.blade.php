...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" style="margin-bottom: 3%;">
		<div class="col-md-12">
			...
			<h3 style="text-align: center;">DELIVANCE D'ETAT DE VERSEMENT</h3>
			<div class="card">
		...
		<div class="col-md-12">
			<div class="card">
				...
				<?php
					...
					echo Form::open(array('url' => 'etat_versement/delivrance'  , 'method' => 'POST'));
		                  ...
		                  <tbody>
		                  	<?php $total = 0; ?>
				                  ...
				                  <tr>
				                   ...
				                   <td><textarea name="esp_{{$caracteristique->id}}" cols="12" rows="3" style="resize: none;" class="form-control">{{$caracteristique->type_exploitation}}</textarea></td>
				                   <td><textarea name="rec_{{$caracteristique->id}}" cols="12" rows="3" style="resize: none;" class="form-control">{{$caracteristique->nature_recette}}</textarea></td>
						...
						<div class="col-md-2 offset-md-2">
							<div class="form-group">
								...
								<?php
										...
										echo Form::submit('Délivrer', array('class' => 'btn btn-block btn-success'));
