<h3 style="text-align: center;padding-top: 2%;">LISTE DES ETATS DE VERSEMENT NON REGLES</h3>
      <div class="card">
                    ...
                    <td>
                      ...
                      <?php
                       ...
                       {?>
                        ...
                        <a type="button" href="{{ Route('regle_etat_versement',$procedure->id) }}" class="btn btn-block btn-primary">Régler</a>
                      <?php
                       } 
                      ?> 
