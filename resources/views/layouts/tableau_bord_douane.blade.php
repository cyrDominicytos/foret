          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <h3>{{ douane_info()['bfu_attente']}} </h3>

                <p>Procédure en attente de BFU</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="{{ Route('scanning', ['details' => 'attente']) }}" class="small-box-footer">En savoir plus <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="{{ Route('scanning', ['details' => 'conforme']) }}" class="small-box-footer">En savoir plus<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{ process_user_info()['process_fermer']}}</h3>

                <p>Procédures Fermées</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="{{ Route('scanning', ['details' => 'non_conforme']) }}" class="small-box-footer">En savoir plus<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
          ...
          <div class="row mb-2">
            <div class="col-sm-4"></div>
              ...
              <div class="card-header">
                <h3 class="card-title">Les 10 dernières procédures d'exportations en attente de traitement</h3>
              </div>
            <div class="col-sm-4"></div>
            </div>
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   {{formater_datetime($procedure->created_at)}}</td>
                    ...
                    <td>
                         <a type="button" href="{{ douane_traiter_link($procedure->id_statut,$procedure->id) }}" class="btn btn-block btn-primary">Traiter</a>
