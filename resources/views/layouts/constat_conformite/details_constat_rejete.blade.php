	...
	<div class="row" style="margin-bottom: 3%;">
		...
		<div class="card-body">
			<div class="col-md-12">
				...
				<?php
				if (trim($procedureEnAttentesDetails->raison_rejet!="")) {
				...
				<div class="row col-md-10 offset-md-1" style="margin-top: 1%">
						...
						echo Form::textarea('observation',$procedureEnAttentesDetails->raison_rejet,array('class' => 'form-control','style'=>'resize:none;border: 1px solid white;font-weight: bold;color: red;font-size: 18px;background-color:white','maxlength'=>'1000','rows'=>'4','disabled'=>true));
