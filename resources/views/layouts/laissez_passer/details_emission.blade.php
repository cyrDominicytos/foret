...
<div class="container-fluid" style="margin-top: 2%;">
	<div class="row" style="margin-bottom: 3%;">
		<div class="col-md-12">
			...
			<h3 style="text-align: center;"><?= (isset($lp)) ? ($t = "EXTENSION DE LAISSEZ-PASSER") : ($t = "EMISSION DE LAISSEZ-PASSER") ?></h3>
			<div class="card">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" style="background-color: #ABB2B9;">
					...
					<h3 class="card-title" style="font-weight: bold;text-align: center;width: 100%;"><?= (isset($lp)) ? ($title = "FORMULAIRE D'EXTENSION DE LAISSEZ-PASSER") : ($title = "FORMULAIRE D'EMISSION DE LAISSEZ-PASSER") ?></h3>
				</div>
				<?php
					
					echo Form::open(array('url' => (isset($lp)) ? ('laissez_passer/etendre') : ('laissez_passer/attente') , 'method' => 'POST','id' => 'lp_form'));
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #E74C3C;">
                            <h4 class="modal-title">Rejet d'une demande de laissez-passer</h4>
                        ...
                        <div class="modal-body">
                            <?php
                            	echo Form::textarea('reasonReject', '', ['id' => 'reasonReject', 'rows' => 8, 'cols' => 20, 'style' => 'resize:none', 'class' => 'form-control', 'placeholder' => 'Taper ici la raison du rejet'])

                            ?>
                        </div>
                        <div class="modal-footer">
		                    <?php
									echo Form::button('Valider', array('class' => 'btn btn-danger','onclick'=>"if(document.getElementById('reasonReject').value != ''){document.getElementById('lp_form').submit();}"));
							?>
