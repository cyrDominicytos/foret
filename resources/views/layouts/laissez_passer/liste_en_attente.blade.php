<h3 style="text-align: center;padding-top: 2%;">LISTE DES DEMANDES EN ATTENTE DE LAISSEZ-PASSER</h3>
      <div class="card">
                      ...
                      @foreach($procedureEnAttentes as $procedureEnAttente)
                        <tr>
                            ...
                            <td>
                               ...
                               <a type="button" class="btn btn-block btn-primary" href="{{ route('show.en_attente', $procedureEnAttente->id) }}">Traiter</a>
                               
                               <a type="button" class="btn btn-block btn-secondary" href="{{ Route('process_show',$procedureEnAttente->id) }}">Voir</a>
