...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        <div> <b style='color: red'> Nature </b> : <b>Demande de laissez-passer rejeté </b></div>
        <div style='background: #fff; padding: 10px; margin:15px 0'><b>Message </b> : 
             <br>La demande de laissez-passer de votre procédure d'exportation vient d'être rejetée.
        ...
        <center><a type="button" href="{{ Route('process_show',$data->id) }}" class="btn btn-block btn-secondary">Voir</a></center>
