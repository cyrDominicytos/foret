...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        <div> <b style='color: red'> Nature </b> : <b>Etat de versement obtenu </b></div>
        <div style='background: #fff; padding: 10px; margin:15px 0'><b>Message </b> : 
             <br>L'état de versement de votre procédure d'exportation vient d'être délivré
       ...
       <table  class="second_tab" id="second_tab" style="width: 100%;margin-bottom: 3%;margin-left: 5%;">
        ...
        <br>
         ...
         <center><a href="{{ Route('process_show',$id_procedure_export) }}"  style="text-align: center;" class="btn btn-secondary btn-circle">Consulter</a></center>
        </div>
