...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        <div> <b style='color: red'> Nature </b> : <b>Constat de conformité obtenu </b></div>
        <div style='background: #fff; padding: 10px; margin:15px 0'><b>Message </b> : 
             <br>Le constat de conformité de la procédure d'exportation {{ $data->numero }} vient d'être délivré et la procédure est en attente de laissez-passer.
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="border:1px solid black;padding: 10px;">{{ formater_datetime($created_at) }}</td>
                </tr>
