...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        <div> <b style='color: red'> Nature </b> : <b>Scanning Délivré </b></div>
        ...
        <table style="width: 70%; margin: auto;">
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    <td style="border:1px solid black;padding: 10px;">Date création</td>
                    <td style="border:1px solid black;padding: 10px;"><?= $data->created_at ?></td>
                </tr> 
                <tr>
                    <td style="border:1px solid black;padding: 10px;">Date Départ</td>
                    <td style="border:1px solid black;padding: 10px;"><?= $data->date_depart ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border:1px solid black;padding: 10px;">Résutat du Scanning</td>
                    <td style="border:1px solid black;padding: 10px;">{{ $resultat }}</td>
                </tr>
                <tr>
                    <td style="border:1px solid black;padding: 10px;">Observation</td>
                    <td style="border:1px solid black;padding: 10px;">{{ (isset($data->raison_rejet)) ? ($data->raison_rejet) : ($data->observation)  }}</td>
                </tr>
        ...
        <center><a href="{{ Route('process_show',$data->id_procedure_exportation) }}"  style="text-align: center;" class="btn btn-secondary btn-circle">Consulter</a></center>
