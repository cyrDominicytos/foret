...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        ...
        <div style='background: #fff; padding: 10px; margin:15px 0'><b>Message </b> : 
             <br>Le contre constat de la procédure d'exportation {{ $data->numero }} vient d'être délivré et la procedure est en attente de l'etat de versement.

              <h4 style="color: blue;text-align: center;">DETAILS DU CONSTRE CONSTAT</h4>
        <table style="width: 70%; margin: auto;">
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>Conformité au constat</td>
                    <td><?= $conformite_constat ?></td>
                </tr>
        ...
        <center><a style="text-align: center;" href="{{ route('show.detail_en_attente', $data->id) }}" class="btn btn-secondary btn-circle">Consulter</a></center>
