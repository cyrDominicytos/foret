...
<body>
    ...
    <div style='background: #f1f1f1; padding:25px; max-width: 900px; font-size: 16px; font-family:Arial;  line-height:1.5'>
        <div> <b style='color: red'> Nature </b> : <b>Demande de VGM </b></div>
        <div style='background: #fff; padding: 10px; margin:15px 0'><b>Message </b> : 
             <br>Le constat de conformité de la procédure d'exportation {{ $data->numero }} vient d'être délivré. Veuillez délivrer la fiche VGM.
