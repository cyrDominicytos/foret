...
return [
    ...
    */
    ...
    'password_reset' => [
        ...
        'line_1'   => 'Vous recevez cet email car nous avons reçu une demande de réinitialisation du mot de passe pour votre compte.',
        'line_2'   => 'Cliquez sur le bouton ci-dessous pour réinitialiser votre mot de passe.:',
        'button'   => 'Réinitialiser le mot de passe',
        'notice'   => 'Si vous n\'avez pas demandé de réinitialisation de mot de passe, aucune autre action n\'est requise.',
    ],

    'step'                 => 'Étape',
    'confirm_email'        => 'Confirmer Courriel',
    'choose_new_password'  => 'Choisir nouveau mot de passe',
